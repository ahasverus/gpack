...
The goal of the R package `gpack` is to provide tools to web scraping Google 
Services (Scholar, Pictures, Trends, Search). As Google does not provide any API
...
Google Services (Scholar, Pictures, Trends, Search). R package version 0.0.1.
